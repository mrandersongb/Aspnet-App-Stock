export default {
  ...
  'menu.Deslogar':'Deslogar',
  'menu.Usuários': 'Usuários',
  'menu.Empresas': 'Empresas',
  'menu.Contabilidade': 'Contabilidade',
  'menu.Contas a Receber': 'Contas a Receber',
  'menu.Contas a Pagar': 'Contas a Pagar',
  'menu.Faturamento.Relatórios':'Relatórios',
  'menu.Faturamento.Cadastros': 'Cadastros',
  'menu.Faturamento.Manutenção': 'Manutenção',
  'menu.logout':'Deslogar',
  'menu.Faturamento.Manutenção.Coletor de Dados':'Coletor de Dados',
  'menu.Faturamento.Manutenção.Movimentação de Estoque':'Movimentação de Estoque',
  'menu.Faturamento.Manutenção.Menu.Movimentação de Estoque':'Movimentação de Estoque',
  'menu.Faturamento.Manutenção.Menu':'Menu'
};
